  ...
  const testimonials = [
    {
      ...
      clientImage: "https://placehold.co/100x100/9CA3AF/1F2937?text=JD"
    },
    {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="mt-8 md:mt-0">
              <ImagePlaceholder src="https://placehold.co/600x450/FFFFFF/333333?text=Precision+Engineering" alt="Precision Engineering" className="rounded-xl shadow-2xl" fallbackText="Engineering" />
            </div>
          </div>
        </div>
      </section>
